...
import dm_env
from environments.pets_cartpole import CartpoleEnv
from environments.pets_halfcheetah import HalfCheetahEnv
from environments.pets_pusher import PusherEnv
from environments.pets_reacher import Reacher3DEnv
...
def make_environment(
    name, seed) -> Tuple[dm_env.Environment, ml_collections.ConfigDict]:
...
def main(unused_argv):
  ...
  environment, config = make_environment(FLAGS.config.env_name,
