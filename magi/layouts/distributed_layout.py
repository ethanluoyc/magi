...
the goal is to directly use the layout definition in Acme when if gives enough flexibility
"""
...
class DistributedLayout:
    ...
    def __init__(
        ...
        *,
        ...
        # TODO(yl): we can probably remove this in favor of configuring logging in subclasses
        log_every: float = 5.0,
    ...
    def build(self, name="agent"):
        ...
        with program.group("actor"):
            for actor_id in range(self._num_actors):
                ...
                program.add_node(
                    lp.CourierNode(
                        self.actor, actor_id, actor_key, replay, learner, counter
                    )
                )
