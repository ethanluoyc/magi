...
class SACLearner(core.Learner):
    ...
    def __init__(
        ...
        def critic_loss(
            ...
            next_action_dist = policy_network.apply(
            ...
            next_q1, next_q2 = critic_network.apply(
                critic_target_params, transitions.next_observation, next_actions
            )
            next_q = jnp.minimum(next_q1, next_q2) - alpha * next_log_probs
            target = jax.lax.stop_gradient(
                transitions.reward + transitions.discount * discount * next_q
            )
            q1, q2 = critic_network.apply(
