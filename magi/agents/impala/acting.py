...
PolicyValueFn = Callable[
    [hk.Params, types.Observation, hk.LSTMState], Tuple[_LogitsAndValue, hk.LSTMState]
]
...
class IMPALAActor(core.Actor):
    ...
    def select_action(self, observation: types.Observation) -> types.Action:
        ...
        # Forward.
        (logits, _), new_state = self._forward(self._params, observation, self._state)
