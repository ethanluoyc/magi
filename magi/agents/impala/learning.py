...
def impala_loss(
    ...
    *,
    ...
    def loss_fn(params: hk.Params, sample: reverb.ReplaySample) -> jnp.DeviceArray:
        ...
        (logits, values), _ = unroll_fn.apply(
            params, observations, initial_state, data.start_of_episode
        )
...
class IMPALALearner(acme.Learner):
    ...
    def __init__(
        ...
        def make_initial_state(key: jnp.ndarray) -> TrainingState:
            ...
            initial_params = unroll_fn.init(key, dummy_obs, initial_state, dummy_reset)
