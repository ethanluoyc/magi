...
from magi.agents.rhpo import learning as learning_lib


class RHPOBuilder(builders.ActorLearnerBuilder):
  """RHPO agent builder"""
  ...
  def __init__(
    ...
    """Create a builder for assembling RHPO agents."""
    self._config = config
  ...
  def make_learner(
    ...
    return learning_lib.RHPOLearner(
