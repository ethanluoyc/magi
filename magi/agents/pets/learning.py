...
class ModelBasedLearner(core.Learner):
  ...
  def _train(self, replay):
    ...
    best_val_score = self._evaluate(self._state.params, self._state.normalizer,
                                    val_iterator)
    for epoch in range(self.num_epochs):
      ...
      eval_score = self._evaluate(self._state.params, self._state.normalizer,
                                  val_iterator)
